              ...
              builder: (context) => AlertDialog(
                content: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Funds in your wallet: ${useUser.state.balance?.getValueInUnit(EtherUnit.ether)} ETH',
                      ),
                      Text(
                        (useUser.state.balance
                                        ?.getValueInUnit(EtherUnit.finney) ??
                                    0) >=
                                2500
                            ? 'Maximum amount you can buy: ${2500} ATN'
                            : 'Maximum amount you can buy: ${useUser.state.balance?.getValueInUnit(EtherUnit.finney)} ATN',
